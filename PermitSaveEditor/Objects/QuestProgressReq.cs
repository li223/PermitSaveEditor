...
namespace PermitSaveEditor.Objects
{
    ...
    {
        [JsonProperty("CURRENT_FP_COUNT")]
        public int CurrentFPCount { get; set; }
        ...
        [JsonProperty("TARGET_FP_COUNT")]
        public int TargetFPCount { get; set; }

        [JsonProperty("TARGET_FP_LEVEL")]
        public int TargetFPLevel { get; set; }
        ...
        [JsonProperty("TARGET_EVENT_TAG")]
        public string TagetEventTag { get; set; }
